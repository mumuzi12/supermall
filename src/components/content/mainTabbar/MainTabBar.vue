<template>
  <tab-bar>
    <tab-bar-item path="/home" activeColor="#FF3F81">
      <img src="~assets/img/tabbar/home.svg" alt slot="item-icon" />
      <img src="~assets/img/tabbar/home_active.svg" alt slot="item-icon-active" />
      <div slot="item-text">首页</div>
    </tab-bar-item>
    <tab-bar-item path="/category" activeColor="#FF3F81">
    ...
    <tab-bar-item path="/cart" activeColor="#FF3F81">
    ...
    <tab-bar-item path="/profile" activeColor="#FF3F81">
